...
async function createData() {
  ...
  const users = [
    ...
    {
      username:
        "SuperLongUsernameThatHasALotOfCharactersToTestResponsiveDesign",
      email: "test@kth.se",
      password: bcrypt.hashSync("test", bcrypt.genSaltSync(10)),
      completedHacks: [challenges[0].title],
